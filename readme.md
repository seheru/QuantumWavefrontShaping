...
Bu nihai aşamada, önceki tüm SPDC ve BPM modelleri birleştirilerek **O. Lib, G. Hasson, Y. Bromberg, *Science Advances* (2020)** makalesindeki deney düzeneği simüle edilmiştir. Saçıcı bir ortamdan (difüzör) geçen dolaşık foton çiftlerinin uzaysal korelasyonları, **kuantum sinyaline hiç dokunulmadan**, sadece klasik pompa lazerinin dalga cephesi şekillendirilerek (SLM) ve klasik şiddet geri beslemesiyle gerçek zamanlı olarak geri kazanılmıştır.
...
#### Optimizasyon Öncesi ve Sonrası Karşılaştırması (Makale Figür 2):
...
#### Gerçek Zamanlı Optimizasyon ve Eşzamanlı Yakınsama (Makale Figür 3):
